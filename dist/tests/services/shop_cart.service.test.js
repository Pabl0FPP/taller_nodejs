...
const shop_cart_service_1 = require("../../src/services/shop_cart.service");
...
describe('ShopCart Service', () => {
    ...
    describe('getOrCreateCart', () => {
        it('should create new cart if not exists', () => __awaiter(void 0, void 0, void 0, function* () {
            const cart = yield shop_cart_service_1.shopcartService.getOrCreateCart(testUserId);
            expect(cart).toBeDefined();
        }));
        it('should return existing cart', () => __awaiter(void 0, void 0, void 0, function* () {
            // Crear carrito primero
            yield shop_cart_service_1.shopcartService.getOrCreateCart(testUserId);
            const cart = yield shop_cart_service_1.shopcartService.getOrCreateCart(testUserId);
            expect(cart).toBeDefined();
    ...
    describe('addItemToCart', () => {
        it('should add new item to cart', () => __awaiter(void 0, void 0, void 0, function* () {
            const cart = yield shop_cart_service_1.shopcartService.addItemToCart(testUserId, {
